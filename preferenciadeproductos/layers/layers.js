...
jsonSource_Preferenciaparacomprarproductos_0.addFeatures(features_Preferenciaparacomprarproductos_0);var lyr_Preferenciaparacomprarproductos_0 = new ol.layer.Vector({
    ...
    title: '<b/>Percepción sobre la preferencia al comprar:</b><br />El degradado de colores en el mapa indica el porcentaje de personas<br />que prefieren  <b/>comprar productos frescos en el mercado.</b><br /><br />\
...
lyr_Preferenciaparacomprarproductos_0.set('fieldAliases', {'Codigo': 'Codigo', 'Canton': 'Canton', 'Provincia': 'Provincia', 'Grafica': 'Grafica', 'Año': 'Año', 'Comprar pr': 'Comprar pr', });
lyr_Preferenciaparacomprarproductos_0.set('fieldImages', {'Codigo': 'Hidden', 'Canton': 'TextEdit', 'Provincia': 'TextEdit', 'Grafica': 'Photo', 'Año': 'TextEdit', 'Comprar pr': 'Hidden', });
lyr_Preferenciaparacomprarproductos_0.set('fieldLabels', {'Canton': 'header label', 'Provincia': 'header label', 'Grafica': 'no label', 'Año': 'header label', });
